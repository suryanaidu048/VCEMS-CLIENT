  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const sumPower = parseFloat(response.data[0].Total_KW_meter_6) + parseFloat(response.data[0].Total_KW_meter_108) + parseFloat(response.data[0].Total_KW_meter_201);
