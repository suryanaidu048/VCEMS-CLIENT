...
const PredictionChart = () => {
  ...
  return (
    <div className="bg-white max-md:py-5 p-0 md:p-1 xl:p-3 2xl:p-5 w-full h-full rounded-lg min-[2200px]:text-2xl 2xl:text-xl text-sm max-[500px]:text-xs max-sm:h-full font-medium shadow font-OpenSans dark:text-white dark:bg-[#2c2c2c]">
      <BarChart
        data={energyData}
        width={600}
        height={300}
