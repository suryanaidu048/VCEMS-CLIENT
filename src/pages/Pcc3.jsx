              ...
              <h2 className='font-bold text-xl text-center underline my-2 mb-6'>PCC3</h2>
                ...
                <div className="param1-div">
                    ...
                    <p
                      className='param-value'
                    >
                      {/* {data?.Total_KW_meter_42.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                      {/* {data?.TotalNet_KWH_meter_42.toFixed(2)} */}0
                    </p>
                    <p
                      className={`param-value ${getPFClass(data?.Avg_PF_meter_42)}`}
                    >
                      {/* {data?.Avg_PF_meter_42.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                  ...
                  <div className="param1-div">
                    ...
                    <p
                      className='param-value'
                    >
                      {/* {data?.Total_KW_meter_43.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                      {/* {data?.TotalNet_KWH_meter_43.toFixed(2)} */}0
                    </p>
                    <p
                      className={`param-value ${getPFClass(data?.Avg_PF_meter_43)}`}
                    >
                      {/* {data?.Avg_PF_meter_43.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                      {/* {data?.Total_KVA_meter_43.toFixed(2)} */}0
                    </p>
                  </div>
                  ...
                  <div className="param1-div">
                    ...
                    >
                      {/* {data?.Avg_PF_meter_44.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                  ...
                  <div className="param1-div">
                    ...
                    <p
                      className='param-value'
                    >
                      {/* {data?.Total_KW_meter_47.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                    ...
                    >
                      {/* {data?.Avg_PF_meter_47.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                  ...
                  <div className="param1-div">
                    ...
                    >
                      {/* {data?.Avg_PF_meter_48.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                  ...
                  <div className="param1-div">
                    ...
                    >
                      {/* {data?.Avg_PF_meter_49.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                  ...
                  <div className="param1-div">
                    ...
                    >
                      {/* {data?.Avg_PF_meter_50.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
                    ...
                    <Link to='/SingleMeter/51'><h2 className='parameter'>
                      ...
                      <p className={`param-value ${getPFClass(data?.Avg_PF_meter_51)}`}>
                        {/* {data?.Avg_PF_meter_51.toFixed(2)} */}0
                      </p>
                      <p className='param-value'>
                    ...
                    <p
                      className='param-value'
                    >
                      {/* {data?.TotalNet_KWH_meter_1.toFixed(2)} */}0
                    </p>
                    <p
                      className={`param-value ${getPFClass(data?.Avg_PF_meter_1)}`}
                    >
                      {/* {data?.Avg_PF_meter_1.toFixed(2)} */}0
                    </p>
                    <p
                      className='param-value'
                    >
